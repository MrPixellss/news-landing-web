...
export default async function ThankYouPage({ searchParams }: ThankYouPageProps) {
  ...
  const isSubscription = params?.subscription === "success";
    ...
    <main className="min-h-screen bg-[#07090b] text-zinc-50">
      <div className="mx-auto flex min-h-screen max-w-3xl flex-col justify-center px-5 py-12">
        ...
        <p className="mt-7 text-lg leading-8 text-[#c7d1dd]">
          {isSubscription
            ? "När Stripe har bekräftat prenumerationen skickar Finansanalytik dagens analyspaket till e-postadressen du angav i kassan. Därefter kan dagliga briefings skickas automatiskt så länge prenumerationen är aktiv."
